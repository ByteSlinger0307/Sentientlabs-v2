...
var hoverBtn1 = document.getElementById("social-btn-elem-1")
var hoverBtn2 = document.getElementById("social-btn-elem-2")
var hoverBtn3 = document.getElementById("social-btn-elem-3")

var btn11 = document.getElementById("social-btn-11")
var btn12 = document.getElementById("social-btn-12")

var btn21 = document.getElementById("social-btn-21")
var btn22 = document.getElementById("social-btn-22")

var btn31 = document.getElementById("social-btn-31")
var btn32 = document.getElementById("social-btn-32")

//  Btn - 1

hoverBtn1.addEventListener("mouseover", () => {
  gsap.to(btn12, {
    transform: "TranslateY(0)",
    duration: 0.2
  })
...
hoverBtn1.addEventListener("mouseleave", () => {
  gsap.to(btn12, {
    transform: "TranslateY(100%)",
    duration: 0.2
  })
...
hoverBtn2.addEventListener("mouseover", () => {
  gsap.to(btn22, {
    transform: "TranslateY(0)",
    duration: 0.2
  })
...
hoverBtn2.addEventListener("mouseleave", () => {
  gsap.to(btn22, {
    transform: "TranslateY(100%)",
    duration: 0.2
    })
  ...
  // Btn - 3
  hoverBtn3.addEventListener("mouseover", () => {
    gsap.to(btn32, {
      transform: "TranslateY(0)",
      duration: 0.2
    })
  ...
  hoverBtn3.addEventListener("mouseleave", () => {
    gsap.to(btn32, {
      transform: "TranslateY(100%)",
      duration: 0.2
    })
